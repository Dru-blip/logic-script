...
const ERROR_HINTS: Map<LgErrorCode, string> = new Map([
  ...
  [LgErrorCode.MISSING_ASSIGNMENT, "Did you mean to use `=` for assignment? e.g., `let x = 5`"],
  ...
  [LgErrorCode.UNEXPECTED_EOF, "Your code seems to end abruptly. Did you forget to close a block, add a semicolon, or complete an expression?"]
]);
